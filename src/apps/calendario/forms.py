...
class EventoForm(forms.ModelForm):
	class Meta:
	    model = Evento
	    exclude = ('idusuario_creac','fec_creac','idusuario_mod','fec_mod','organismo','dependencia')
	    widgets = {
...
class EventoConsultaForm(forms.Form):
...
class EventoTable(tables.Table):
    ...
    acciones = tables.TemplateColumn("""<div style='text-align:center'>
