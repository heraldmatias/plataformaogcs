...
class MccForm_ActorTable(tables.Table):
    ...
    actor = tables.TemplateColumn('<input type="hidden" name="listactor" value="{{ record.actor }}">{{ record.actor }}', visible=False)
...
class MccForm_LiderTable(tables.Table):
    ...
    lider = tables.TemplateColumn('<input type="hidden" name="listlider" value="{{ record.lider }}">{{ record.lider }}', visible=False)
