...
urlpatterns = patterns('dependencia.views',
    ...
    url(r'^ministerio/imprimir/$','ministerioprint', name='ogcs-mantenimiento-ministerio-print'),
    ...
    url(r'^odp/imprimir/$','odpprint', name='ogcs-mantenimiento-odp-print'),
    ...
    url(r'^gobernacion/imprimir/$','gobernacionprint', name='ogcs-mantenimiento-gobernacion-print'),
