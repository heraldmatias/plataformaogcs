...
urlpatterns = patterns('home.views',
    ...
    url(r'^accounts/password/reset/$', password_reset,{'template_name':'home/cambiar_clave.html','email_template_name':'home/email_cambio_clave.html','extra_context':{'login':'login'}},name='ogcs-reset-pass'),
